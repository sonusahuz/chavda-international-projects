  ...
  return (
    <div>
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-lg px-4 md:px-5 lg:px-10 xl:px-24">
      ...
      <!-- product - start --> */}
          ...
          <div className="flex flex-col items-end gap-4">
            ...
            <Button className="inline-block rounded-lg h-11 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 focus-visible:ring md:text-base">
              Check out
            </Button>
          </div>
        </div>
